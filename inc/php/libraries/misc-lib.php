<?php
	...
	$file_navigation = $root_php.'navigation/menu.php';
	...
	$file_header_tag = $root_php.'components/header-tag.php';
...
// site main menu
	$menu = (object) [
		...
		'pos' => (object) ['url' => '/storytelling/', 'title' => 'the power of storytelling'],
